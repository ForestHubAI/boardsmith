...
// --- SX1276 LoRa/FSK Transceiver initialization ---
static void init_SX1276() {
    // Phase: configure
    // Write 0x01 = 0x80 — Sleep mode, LoRa
    _i2c_write(I2C_ADDR_SX1276, 0x01, 0x80);
    // Write 0x1D = 0x72 — BW 125kHz, CR 4/5
    _i2c_write(I2C_ADDR_SX1276, 0x1D, 0x72);
    // Write 0x1E = 0x74 — SF7, CRC on
    _i2c_write(I2C_ADDR_SX1276, 0x1E, 0x74);
    // Phase: enable
    // Write 0x01 = 0x81 — Standby mode
    _i2c_write(I2C_ADDR_SX1276, 0x01, 0x81);
}

...
**Session:** `bdd9c08e-d0fa-44e2-bbf4-4cc07401d127`
...
- **i2c0** (I2C): master=RP2040, slaves=['SSD1306'], addresses=[SSD1306@0x3C]
- **qspi_boot** (SPI): master=RP2040, slaves=['W25Q16JVSSIQ'], addresses=[]

## Bill of Materials

- Lines: 38
- Estimated cost: $8.62 USD
...
- Supply 5.0V > MCU VDD_MAX 3.6V — adding AMS1117-3.3 LDO (800mA capacity, est. load 3054mA) on VIN_5V→3V3_REG
- Thermal warning: AMS1117-3.3 fallback dissipates 5.2W (5V→3.3V @ 3054mA) — consider a switching regulator

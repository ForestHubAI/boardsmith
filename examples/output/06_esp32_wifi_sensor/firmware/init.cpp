...
// --- BME680 Environmental Sensor + VOC Gas initialization ---
static void init_BME680() {
    // Phase: reset
    delay(10);
    // Write 0xE0 = 0xB6 — Soft reset
    _i2c_write(I2C_ADDR_BME680, 0xE0, 0xB6);
    // Phase: configure
    // Write 0x72 = 0x01 — Humidity oversampling x1
    _i2c_write(I2C_ADDR_BME680, 0x72, 0x01);
    // Write 0x74 = 0x27 — Temp x1, Press x1, forced mode
    _i2c_write(I2C_ADDR_BME680, 0x74, 0x27);
    // Write 0x5A = 0x73 — Heater resistance 300C
    _i2c_write(I2C_ADDR_BME680, 0x5A, 0x73);
    // Write 0x64 = 0x59 — Gas wait 100ms
    _i2c_write(I2C_ADDR_BME680, 0x64, 0x59);
    // Write 0x71 = 0x10 — Enable gas measurement
    _i2c_write(I2C_ADDR_BME680, 0x71, 0x10);
}
